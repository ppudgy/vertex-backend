...
public interface ContactRepository extends CrudRepository<Contact, UUID> {
    ...
    List<Contact> findBySchemataAndPersonAndContactLike(UUID schema, UUID person, String contact);
    List<Contact> findBySchemataAndPersonAndTypeofcontact(UUID schema, UUID person, UUID type);
    List<Contact> findBySchemataAndPersonAndTypeofcontactAndContactLike(UUID schema, UUID person, UUID type, String contact);
